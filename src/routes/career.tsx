...
export const Route = createFileRoute("/career")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Join Struxup. Build your engineering career with a multidisciplinary consultancy in Amaravathi, AP." },
      { property: "og:title", content: "Careers at Struxup" },
      { property: "og:description", content: "Engineering careers across civil, structural, MEP, renewable and more." },
    ],
  }),
  component: Career,
});
    ...
    <>
      <section className="bg-gradient-hero py-20 text-primary-foreground sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-accent-glow">Careers</p>
          <h1 className="mt-3 max-w-3xl font-display text-4xl font-extrabold sm:text-5xl">Build the future. Build it with us.</h1>
          <p className="mt-5 max-w-2xl text-primary-foreground/85">We're always looking for sharp, curious engineers who want to leave a mark on real-world infrastructure.</p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div key={c.title} className="rounded-2xl border border-border bg-card p-6 shadow-card-soft">
        ...
        <div className="mt-20">
          ...
          <p className="mt-8 text-sm text-muted-foreground">
            ...
            <a className="font-semibold text-primary hover:text-accent" href="mailto:eswarvinay@struxup.net">eswarvinay@struxup.net</a>.
          </p>
        </div>
      </section>
    </>
