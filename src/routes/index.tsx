  ...
  head: () => ({
    meta: [
      { title: "Struxup Engineers & Infra — Engineering Consultancy in Rajahmundry" },
      {
        name: "description",
        content:
          "Multidisciplinary engineering consultancy: civil, structural, MEP, architectural, renewable energy & hydro projects.",
      },
      { property: "og:title", content: "Struxup Engineers & Infra Pvt. Ltd." },
      {
        property: "og:description",
        content:
          "Engineering consultancy & design — civil, structural, MEP, renewable & hydro projects.",
      },
    ],
  }),
  component: Home,
...
function Home() {
  return (
    <>
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-28 sm:px-6 lg:px-8 lg:py-40">
          <div className="max-w-3xl text-primary-foreground">
            ...
            <p className="mt-6 max-w-2xl text-base leading-relaxed text-primary-foreground/85 sm:text-lg">
              Struxup Engineers & Infra Pvt. Ltd. delivers integrated civil, structural, MEP,
              architectural and renewable energy consultancy — engineered for performance, built for
              permanence.
            </p>
            <div className="mt-9 flex flex-wrap gap-4">
              <a
                href="#services"
                className="inline-flex items-center gap-2 rounded-md bg-gradient-accent px-7 py-3.5 text-sm font-semibold text-accent-foreground shadow-glow transition-smooth hover:scale-[1.02]"
              >
                Our Services <ArrowRight className="h-4 w-4" />
              </a>
              <a
                href="#contact"
                className="inline-flex items-center gap-2 rounded-md border border-white/40 bg-white/5 px-7 py-3.5 text-sm font-semibold text-primary-foreground backdrop-blur transition-smooth hover:bg-white/15"
              >
                Talk to an Engineer
              </a>
            </div>
      ...
      <section id="about" className="scroll-mt-24 mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 font-display text-3xl font-bold text-foreground sm:text-4xl">
            Engineering trust through every project, every detail.
          </h2>
          <p className="mt-4 text-muted-foreground">
            A multidisciplinary consultancy delivering complete engineering solutions across civil,
            structural, MEP, renewable energy and hydro projects.
          </p>
        </div>
          ...
          {[
            {
              icon: Target,
              title: "Our Mission",
              body: "Deliver safe, sustainable and economical engineering solutions that endure.",
            },
            {
              icon: Eye,
              title: "Our Vision",
              body: "Be India's most trusted multidisciplinary engineering consultancy.",
            },
            {
              icon: Award,
              title: "Our Values",
              body: "Integrity, technical rigor, sustainability and on-time delivery.",
            },
          ].map((c) => (
            <div
              key={c.title}
              className="rounded-2xl border border-border bg-card p-8 shadow-card-soft transition-smooth hover:-translate-y-1 hover:shadow-elegant"
            >
      ...
      <section id="who-we-are" className="scroll-mt-24 bg-secondary/40 py-20">
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <div className="overflow-hidden rounded-3xl shadow-elegant">
            <img
              src={team}
              alt="Struxup engineers collaborating"
              className="h-full w-full object-cover"
              loading="lazy"
              width={1280}
              height={800}
          ...
          <div>
            ...
            <h2 className="mt-3 font-display text-3xl font-bold text-foreground sm:text-4xl">
              A collective solving the hardest problems in infrastructure.
            </h2>
            <p className="mt-5 text-foreground/80 leading-relaxed">
              Struxup unites civil engineers, structural designers, MEP specialists, architects and
              renewable-energy consultants — working in tightly integrated teams from sketch to
              site.
            </p>
            <ul className="mt-6 space-y-4">
              {[
                {
                  icon: Users,
                  t: "Multidisciplinary team — every relevant discipline under one roof.",
                },
                {
                  icon: Briefcase,
                  t: "Sector experience across commercial, industrial, transport, energy.",
                },
                {
                  icon: ShieldCheck,
      ...
      <section
        id="services"
        className="scroll-mt-24 mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28"
      >
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-muted-foreground">
            From concept design to final commissioning, we are your single accountable partner.
          </p>
        </div>
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((s) => (
            <div
              key={s.title}
              className="group rounded-2xl border border-border bg-card p-7 shadow-card-soft transition-smooth hover:-translate-y-1 hover:shadow-elegant"
            >
        ...
        <div className="mt-12 grid items-center gap-10 rounded-3xl bg-gradient-brand p-8 text-primary-foreground shadow-elegant lg:grid-cols-2 lg:p-12">
          ...
          <div>
            ...
            <p className="mt-4 text-primary-foreground/85">
              ...
              meets today's demand while future-proofing assets.
            </p>
            <Link
              to="/services"
              className="mt-6 inline-flex items-center gap-2 rounded-md bg-gradient-accent px-6 py-3 text-sm font-semibold text-accent-foreground shadow-card-soft transition-smooth hover:shadow-glow"
            >
      ...
      <section id="career" className="scroll-mt-24 bg-secondary/40 py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              Sharp, curious engineers who want to leave a mark on real-world infrastructure.
            </p>
          </div>
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              },
              {
                icon: Briefcase,
                title: "Career Growth",
                desc: "Clear paths into leadership roles.",
              },
            ].map((c) => (
              <div
                key={c.title}
                className="rounded-2xl border border-border bg-card p-6 shadow-card-soft transition-smooth hover:-translate-y-1 hover:shadow-elegant"
              >
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        <div>
          ...
          <input
            name="name"
            required
            className="w-full rounded-md border border-input bg-background px-3.5 py-2.5 text-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-ring/30"
          />
        </div>
        <div>
          <label className="mb-2 block text-sm font-medium">
